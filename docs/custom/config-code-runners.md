...
The runner can either return a text or HTML output, or an element to be mounted. Refer to https://github.com/nholuongut/slidev/blob/main/packages/types/src/code-runner.ts for more details.
