...
For more properties available, refer to the [`SlidevContextNav` interface](https://github.com/nholuongut/slidev/blob/main/packages/client/composables/useNav.ts).
