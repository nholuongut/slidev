...
export default defineConfig({
  ...
  themeConfig: {
    logo: '/logo.svg',
    editLink: {
      pattern: 'https://github.com/nholuongut/slidev/edit/main/docs/:path',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/nholuongut/slidev' },
      { icon: 'twitter', link: 'https://twitter.com/nholuongut' },
    ...
    sidebar: {
      ...
      '/builtin/': slidebars,
      '/resources/': slidebars,
      // eslint-disable-next-line nholuongut/no-top-level-await
    ...
    footer: {
      ...
      copyright: 'Copyright © 2020-2024 Nho Luong.',
    },
  },
