...
export const official: ThemeInfo[] = [
  {
    ...
    author: {
      name: 'Nho Luong',
      link: 'https://github.com/nholuongut',
    },
    repo: 'https://github.com/nholuongut/themes/tree/main/packages/theme-default',
    previews: [
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-default/01.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-default/02.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-default/06.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-default/08.png',
    ],
    tags: [
      'official',
      'minimalism',
  ...
  },
  {
    ...
    repo: 'https://github.com/nholuongut/themes/tree/main/packages/theme-seriph',
    previews: [
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-seriph/01.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-seriph/02.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-seriph/03.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-seriph/08.png',
    ],
    tags: [
      'official',
      'minimalism',
  ...
  },
  {
    ...
    repo: 'https://github.com/nholuongut/themes/tree/main/packages/theme-apple-basic',
    previews: [
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-apple-basic/01.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-apple-basic/02.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-apple-basic/03.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-apple-basic/09.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-apple-basic/11.png',
    ],
    tags: [
      'minimalism',
      'dark',
  ...
  },
  {
    ...
    repo: 'https://github.com/nholuongut/themes/tree/main/packages/theme-bricks',
    previews: [
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-bricks/01.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-bricks/04.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-bricks/06.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-bricks/05.png',
    ],
    tags: [
      'light',
    ],
  },
  {
    ...
    repo: 'https://github.com/nholuongut/themes/tree/main/packages/theme-shibainu',
    previews: [
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-shibainu/01.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-shibainu/03.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-shibainu/04.png',
      'https://cdn.jsdelivr.net/gh/nholuongut/themes@main/screenshots/theme-shibainu/09.png',
    ],
    tags: [
      'dark',
    ],
...
export const community: ThemeInfo[] = [
  ...
  {
    id: '',
    link: 'https://github.com/nholuongut/docs/edit/main/.vitepress/themes.ts',
    name: 'Yours?',
