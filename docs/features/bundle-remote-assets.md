...
For remote assets, the built-in [`vite-plugin-remote-assets`](https://github.com/nholuongut/vite-plugin-remote-assets) will cache them onto the disk at first run, ensuring instant loading even for large images later on.
