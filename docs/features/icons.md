...
relates:
  ...
  - unplugin-icons: https://github.com/nholuongut/unplugin-icons
tags: [components]
description: |
...
Slidev allows you to have access to virtually all open-source icon sets **directly** in your markdown after installing the corresponding package. Powered by [`unplugin-icons`](https://github.com/nholuongut/unplugin-icons) and [Iconify](https://iconify.design/).
